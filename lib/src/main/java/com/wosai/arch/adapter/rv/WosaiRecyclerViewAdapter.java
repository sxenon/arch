...
import com.wosai.arch.viewmodule.pull.list.IListViewModule;
...
public abstract class WosaiRecyclerViewAdapter<R> extends RecyclerView.Adapter<WosaiRecyclerViewViewHolder> implements IWosaiAdapter<R> {
    private final SparseArray<WosaiRecyclerViewItemViewTypeEntity> mItemViewTypeEntryArray;
     ...
     * @param itemViewTypeEntryArray key = {@link #getItemViewType(int)} ,value = {@link WosaiRecyclerViewItemViewTypeEntity}
     */
    public WosaiRecyclerViewAdapter(IListViewModule<R> container, SparseArray<WosaiRecyclerViewItemViewTypeEntity> itemViewTypeEntryArray) {
    ...
    @NonNull
    @Override
    public WosaiRecyclerViewViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        WosaiRecyclerViewViewHolder viewHolder = null;

        WosaiRecyclerViewItemViewTypeEntity itemViewTypeEntity = mItemViewTypeEntryArray.get(viewType);
        ...
        Class<? extends WosaiRecyclerViewViewHolder> viewHolderClass = itemViewTypeEntity.getViewHolderClass();
        try {
            Constructor<? extends WosaiRecyclerViewViewHolder> constructor = viewHolderClass.getConstructor(View.class, WosaiRecyclerViewAdapter.class);
            viewHolder = constructor.newInstance(itemView, WosaiRecyclerViewAdapter.this);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return viewHolder;
    ...
    @Override
    public void onBindViewHolder(@NonNull WosaiRecyclerViewViewHolder holder, int position) {
    ...
    public SparseArray<WosaiRecyclerViewItemViewTypeEntity> getItemViewTypeEntryArray() {
