package com.wosai.arch.select.notifier;
...
public class WosaiAdapterSelectOptionChangeNotifier<T> implements ISelectOptionChangeNotifier<T> {
    private final IWosaiAdapter<T> adapter;

    public WosaiAdapterSelectOptionChangeNotifier(IWosaiAdapter<T> adapter) {
