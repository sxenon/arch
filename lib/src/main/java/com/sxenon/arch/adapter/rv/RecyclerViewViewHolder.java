...
public abstract class RecyclerViewViewHolder<T> extends RecyclerView.ViewHolder implements IAdapterViewHolder<T> {
    private final RecyclerViewAdapter adapter;
    private final IViewModule adapterContainer;
    private int height, width;

    public RecyclerViewViewHolder(View itemView, RecyclerViewAdapter adapter) {
        super(itemView);
